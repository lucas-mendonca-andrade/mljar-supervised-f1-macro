...
- for binary classification: `logloss`, `auc`, `f1`, `f1_macro`, `average_precision`, `accuracy` - default is `logloss`
- for multiclass classification: `logloss`, `f1`, `f1_macro`, `accuracy` - default is `logloss`
